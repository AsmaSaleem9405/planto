...
const PlantCard = ({ plant, isPriority }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image container setup at a clean fixed height */}
      ...
      {/* Text block handles text clipping layout gracefully */}
      ...
      {/* Purchase / Price Section remains perfectly lined up along bottom */}
      <motion.div
        variants={textVariants}
