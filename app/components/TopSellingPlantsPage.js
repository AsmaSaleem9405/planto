    ...
    <>
      ...
      >
        ...
        <footer className="w-full max-w-xs flex justify-between items-center mt-28 mx-auto">
          ...
          <Link href="/top-selling/page-2" className="p-4 rounded-full bg-[#1d271e]/80 border border-emerald-900/40 text-zinc-400 hover:text-white hover:bg-emerald-800 hover:border-emerald-600 transition-all duration-200 shadow-lg">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6">
